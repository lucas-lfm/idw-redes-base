...
1. Para definir o ícone de pesquisa no campo de busca, vamos utilizar a biblioteca `react-icons`. Dessa forma, abra o terminal integrado do VS Code na pasta do projeto e execute o comando `npm install react-icons`.
